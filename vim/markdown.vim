...
syn cluster markdownInline contains=markdownLineBreak,markdownLinkText,markdownItalic,markdownBold,markdownCode,markdownEscape,@htmlTop,markdownError,markdownValid,markdownDoubleEqual
...
exe 'syn region markdownDoubleEqual matchgroup=markdownDoubleEqualDelimiter start="\w\@<!==\S\@=" end="\S\@<===\w\@!" skip="\\_" contains=markdownLineStart,@Spell' . s:concealends
...
hi def link markdownDoubleEqual           htmlDoubleEqual
hi def link markdownDoubleEqualDelimiter  markdownDoubleEqual
